  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[rgba(26,32,54,0.88)] via-[rgba(26,32,54,0.62)] to-[rgba(26,32,54,0.25)]" />
      ...
      <div className="relative z-10 w-full max-w-[780px] px-6 md:px-16">
        ...
        <motion.h1
          ...
          className="mb-6 text-[clamp(2.25rem,7vw,4.5rem)] leading-[1.05] font-bold tracking-tight text-white"
        ...
        >
          ...
          <em className="text-secondary not-italic">Curated for Your Home.</em>
        ...
        <motion.p
          ...
          className="mb-11 max-w-lg text-base text-white/80 md:text-lg"
        ...
        >
          ...
          <Link
            ...
            className="inline-block rounded-md border border-white/40 px-8 py-4 text-center text-sm font-semibold tracking-wide text-white uppercase no-underline transition-colors hover:border-white/70 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary sm:px-10"
